...
Blockly.Blocks['AirsenseWriteAnalog'] = {
  init: function() {
  this.appendDummyInput()
      .appendField("Ghi dữ liệu Analog")
      .appendField(new Blockly.FieldDropdown(Analog_pin_esp32), "Analog_Pin")
      .appendField("Giá trị")
...
Blockly.Blocks['AirsenseReadAnalog'] = {
  init: function() {
  this.appendDummyInput()
      .appendField("Đọc dữ liệu Analog")
      .appendField(new Blockly.FieldDropdown(Analog_pin_esp32), "Analog_Pin")
  this.setColour('#00abd6');
  this.setInputsInline(false);
  this.setOutput(true, "Number");
...
Blockly.Blocks['AirsenseWriteDigital'] = {
  init: function() {
  this.appendDummyInput()
      .appendField("Ghi dữ liệu Digital")
      .appendField(new Blockly.FieldDropdown(Digital_pin_esp32), "Digital_Pin")
      .appendField("Giá trị")
...
Blockly.Blocks['AirsenseReadDigital'] = {
  init: function() {
  this.appendDummyInput()
      .appendField("Đọc dữ liệu Digital")
      .appendField(new Blockly.FieldDropdown(Digital_pin_esp32), "Digital_Pin")
  this.setColour('#00abd6');
  this.setInputsInline(false);
  this.setOutput(true, "Number");
...
Blockly.Blocks['ESP32_wireless'] = {
  init: function() {
      var dropdown = new Blockly.FieldDropdown([["Wifi","Wifi"],["Bluetooth","Bluetooth"]], function(option) {
      ...
      this.setFieldValue("Wifi", "Select");
      this.updateShape_("Wifi");
  },
  onchange: function() {
  ...
  updateShape_: function(option) {
      // Bỏ khoảng trắng thừa trong option
...
Blockly.Blocks['ConnectMQTT'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("PORT:")
        .appendField(new Blockly.FieldTextInput("1000"), "PORT");
    this.appendDummyInput()
        .appendField("ID:")
