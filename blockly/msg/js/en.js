...
Blockly.Msg.robocarv2 = "When KC-Bot starts up";
Blockly.Msg.kcbot_motor_motor = "Select mottor";
Blockly.Msg.kcbot_motor_speed = "Setup Speed";
Blockly.Msg.kcbot_ledrgb = "Setup led";
Blockly.Msg.kcbot_ledrgb_red = "led";
Blockly.Msg.kcbot_ledrgb_green = "green";
Blockly.Msg.kcbot_ledrgb_blue = "blue";
Blockly.Msg.kcbot_servo_setup = "Setup servo";
Blockly.Msg.kcbot_servo_angle = "angle";
Blockly.Msg.kcbot_tone_note = "Setup music note";
Blockly.Msg.kcbot_tone = "beats";
Blockly.Msg.kcbot_lcd_display = "LCD display text";
Blockly.Msg.kcbot_lcd_pos = "postision";
Blockly.Msg.kcbot_lcd_clear = "clear text";
Blockly.Msg.kcbot_rtc_set_time = "Setup time";
Blockly.Msg.kcbot_rtc_set_time_dayofweek = "day of week";
Blockly.Msg.kcbot_rtc_set_time_mon = "Monday";
Blockly.Msg.kcbot_rtc_set_time_tues = "Tuesday";
Blockly.Msg.kcbot_rtc_set_time_wed = "Wednesday";
Blockly.Msg.kcbot_rtc_set_time_thur = "Thursday";
Blockly.Msg.kcbot_rtc_set_time_fri = "Friday";
Blockly.Msg.kcbot_rtc_set_time_sat = "Saturday";
Blockly.Msg.kcbot_rtc_set_time_sun = "Sunday";
Blockly.Msg.kcbot_rtc_update = "Update time";
Blockly.Msg.kcbot_rtc_read_time = "Read hour";
Blockly.Msg.kcbot_rtc_read_date = "Read date";
Blockly.Msg.kcbot_readlm35 = "Read temprature (LM35)";
Blockly.Msg.kcbot_dht11_temp = "Read temprature (DHT11)";
Blockly.Msg.kcbot_dht11_humi = "Read Humidity (DHT11)";
Blockly.Msg.kcbot_ultrasonic = "Read distance";
Blockly.Msg.kcbot_rtc_read = "Read real time";
Blockly.Msg.kcbot_rtc_read_hour = "Hour";
Blockly.Msg.kcbot_rtc_read_min = "Minute";
Blockly.Msg.kcbot_rtc_read_sec = "Second";
Blockly.Msg.kcbot_rtc_read_dayofweek = "Day of week";
Blockly.Msg.kcbot_rtc_read_date = "Date";
Blockly.Msg.kcbot_rtc_read_month = "Month";
Blockly.Msg.kcbot_rtc_read_year = "Year";
Blockly.Msg.loop_forever = "Loop forever";
Blockly.Msg.loop_forever_do = "do";
Blockly.Msg.ARD_nhietdo = "Read temp pin#";
Blockly.Msg.kcbot_sotrungvi = "Get Median Num with analog";
Blockly.Msg.kcbot_123 = "Connect Wifi name";
Blockly.Msg.kcbot_mat = "pass";
Blockly.Msg.kcbot_api = "Send data";
Blockly.Msg.kcbot_run = "at power";
Blockly.Msg.kcbot_run_stop = "Stop";
Blockly.Msg.kcbot_run_forward = "Move forward";
Blockly.Msg.kcbot_run_back = "Move back";
Blockly.Msg.kcbot_run_left = "Turn left";
Blockly.Msg.kcbot_run_right = "Turn right";
Blockly.Msg.kcbot_run_forward_at_sec = "at";
Blockly.Msg.sec = "secs";
Blockly.Msg.kcbot_stop_moving = "Stop moving";
Blockly.Msg.kcbot_ultrasonic_trig = "Read ultrasonic trig pin";
Blockly.Msg.kcbot_ultrasonic_echo = "echo pin";
Blockly.Msg.kcbot_getIr = "channels";
Blockly.Msg.kcbot_getIr_key = "key";
Blockly.Msg.kcbot_getIr_key_go = "up";
Blockly.Msg.kcbot_getIr_key_back = "down";
Blockly.Msg.kcbot_getIr_key_left = "left";
Blockly.Msg.kcbot_getIr_key_right = "right";
...
Blockly.Msg.kcbot_Serial_read = "Serial read";
Blockly.Msg.kcbot_read_data_ir = "Read IR pin";
Blockly.Msg.kcbot_Write = "WirteAPIKey";
Blockly.Msg.kcbot_bang = "up chart";




Blockly.Msg.kcbot_read_Doam = "";
Blockly.Msg.kcbot_textbien_ch = "Variable";
Blockly.Msg.kcbot_textbien_ba = "of the equal function";
Blockly.Msg.kcbot_trans_name = "Wifi hotspot name";
Blockly.Msg.kcbot_trans_pass = "pass";
Blockly.Msg.kcbot_Blynk_Api = "Token api";
Blockly.Msg.kcbot_Blynk_Name = "name wifi";
Blockly.Msg.kcbot_Blynk_Pass = "pass";
Blockly.Msg.Arduino_robot_motor = "Select mottor";
Blockly.Msg.Arduino_robot_motor_ch = "spin";
Blockly.Msg.Arduino_robot_motor_up = "up";
Blockly.Msg.Arduino_robot_motor_down = "down";
Blockly.Msg.Arduino_robot_run = "Arduino robot";
Blockly.Msg.Arduino_robot_motor_stop = "stop";
Blockly.Msg.Arduino_robot = "When Arduino robot starts up";
Blockly.Msg.Arduino = "When Arduino starts up";
Blockly.Msg.python_robot = "When Python robot starts up";
Blockly.Msg.Python_start = "Start"
Blockly.Msg.bluetooth_setup = "Play bluetooth with name: ";
Blockly.Msg.bluetooth_read = "Read data received from Bluetooth";
Blockly.Msg.ARD_bluetooth_write = "Send data";
Blockly.Msg.ARD_bluetooth = "via bluetooth";
Blockly.Msg.Python_run_out_put = "Set pin";
Blockly.Msg.Python_run_out = "level";
Blockly.Msg.Python_run_out_put_high = "High";
Blockly.Msg.Python_run_out_put_low = "LOW";
Blockly.Msg.Python_pwm_out_put = "Setting PWM pin";
Blockly.Msg.Python_pwm_out = "arrive";
Blockly.Msg.Python_digital_read = "Read the number of pins";
Blockly.Msg.Python_analog_read = "Read pin analog value";
Blockly.Msg.kcbot_Python_servo = "turn angle";
Blockly.Msg.python_robot = "When the Python robot starts";
Blockly.Msg.Python_start = "Begin";
Blockly.Msg.kcbot_lcd_dia_chi = "address";
