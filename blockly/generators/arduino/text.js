...
Blockly.Arduino['textchar'] = function(block) {
  var code = Blockly.Arduino.ngoacdon_(block.getFieldValue('TEXT'));
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};
Blockly.Arduino['textkt'] = function(block) {
  var code = Blockly.Arduino.khongngoac_(block.getFieldValue('TEXT'));
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};
Blockly.Arduino['textbien'] = function(block) {
  var code = Blockly.Arduino.khongngoac_(block.getFieldValue('TEXT'));
  var speed = Blockly.Arduino.khongngoac_(block.getFieldValue('TEXT1'));
  return code + '=' + speed +';\n' ;
};
/**
