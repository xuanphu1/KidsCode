...
Ardublockly.reload=function(){
  var blockCount = Ardublockly.workspace.getAllBlocks().length;
  if (blockCount > 0) {
    Ardublockly.alertMessage(
        Ardublockly.getLocalStr('newFileTitle'),
        Ardublockly.getLocalStr('newFileBody'),
        true,
        function() {
          Ardublockly.workspace.clear();
          Ardublockly.renderContent();
...
/** Wraps the blockly 'copy' functionality. AZ*/
